...
The details of the specific algortihm used, as well as the methods for implementing the linear equation solver, matrix inverse method and detminant method is described in the Out.txt, where the results are also found. 
Throughout the project, it is assumed that the routine should work on real symmetric positive definite matrices, as also specified in the project decription.
